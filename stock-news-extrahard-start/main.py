...
r = get("https://www.alphavantage.co/query", params=payload)

date_1 = (datetime.today() - timedelta(days=1))
date_2 = (date_1 - timedelta(days=1)).strftime("%Y-%m-%d")
date_1 = date_1.strftime("%Y-%m-%d")

date1_market_data = r.json()['Time Series (Daily)'][date_1]
date2_market_data = r.json()['Time Series (Daily)'][date_2]
